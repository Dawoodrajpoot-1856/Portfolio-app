...
const projectsList = [
  {
    ...
    description:
      "Telecom web application featuring custom authentication workflows, email OTP verification, dynamic shopping cart drawer, and interactive forms.",
    image: "/phonico.png",
    tags: ["Next.js", "Redux Toolkit", "MongoDB", "Zod"],
  ...
  },
  {
    ...
    description:
      "Feature-rich accommodation booking platform featuring sticky search headers, category filter carousels, detailed listing cards, and help center accordions.",
    image: "/Airbnb.png",
  ...
  },
  {
    ...
    description:
      "A creative text styling tool for generating stylized symbols, fancy characters, and custom formatted bios for social media.",
    image: "/Love.png",
